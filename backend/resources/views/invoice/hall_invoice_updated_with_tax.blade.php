...
<body>
                                ...
                                <div
                                    ...
                                    <div>
                                        <span>Guest Info:</span> <br>
                                            ...
                                            <br>
                                        <div>
                                            {{ ucfirst(($booking->customer->full_name ?? '')) }}
                                            <br>
                                    ...
                                    <div style="width: 300px;">
                                        ...
                                        <div id="editable_container">
                                            <!-- Initially, display normal text -->
                                            <div id="display_text" style="white-space: pre-wrap;"></div>


                                            <!-- Hidden textarea -->
                                            <textarea id="editable_field" style="display:none;" placeholder="Write anything..."></textarea>
                                    ...
                                    <div>
                                        ...
                                        <br />
                                        <div>
                                            <span>{{$bookingType == 'hall'  ? "" : "Room"}} Type:</span> <br>
                                    ...
                                    <table>
                                        <thead>
                                            <tr class="inv-room-th-txt">
                                                ...
                                                @endif
                                                <th class="  tm_semi_bold tm_primary_color">Hall</th>
                                        ...
                                        <tbody>
                                            ...
                                            $room_base = $room->price_adjusted_after_dsicount;
                                            $room_sgst = $room->sgst;
                                            $room_cgst = $room->cgst;
            ...
            <div class="tm_invoice_btns tm_hide_print" id="print_btn">
                ...
                <button id="tm_edit_btn" class="tm_invoice_btn tm_color2">
                    <span class="tm_btn_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                            <path
                                d="M364.13 125.25L386.75 147.87 172.5 362.12 149.87 339.5 364.13 125.25zM403.13 86.25l22.63 22.62c12.5 12.5 12.5 32.75 0 45.25L400 180l-67.88-67.88 25.75-25.75c12.5-12.5 32.75-12.5 45.26 0zM144 336l32 32L96 448H64v-32L144 336z"
                                fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="32" />
                        </svg>
                    </span>
    ...
    <script>
        ...
        $('#tm_edit_btn').on('click', function() {
            $('#display_text').hide();
            $('#editable_field').val($('#display_text').text()).show();
            $('#save_btn').show();
        });
