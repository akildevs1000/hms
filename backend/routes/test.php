...
Route::get('truncate', function () {
    ...
    // $arr = [
    //     ["extend_room_price" => -1120],
    //     ["extend_room_price" => -1120],
    // ];

    // return  $extraDaysAmount = array_sum(array_column($arr, 'extend_room_price'));
...
Route::get('send_msg', function () {
   ...
   More https://www.youtube.com/watch?v=tF-8q991Prw&ab_channel=HYDERSPARK-GroupOfHotels.";
    ...
    $response = Http::withoutVerifying()->get("https://wanow.in/api/send.php", [
        'number' => "916374046207",
        // 'number' => "971502848071",
        'type' => 'text',
        'message' => $msg,
        'instance_id' => "63E1E6FD63F61",
        'access_token' => "91bb84d5e47226ee1cb1d0e642fa196d",
    ]);
