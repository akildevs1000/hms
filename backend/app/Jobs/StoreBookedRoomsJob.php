        ...
        try {
            ...
            foreach ($rooms as $room) {
                ...
                foreach ($priceList as $list) {
                    ...
                    $eachRoomFoodPlanPrice = $bookedRoomId->food_plan_price / count($rooms);

                    $orderRooms['room_discount'] = $singleDayDiscount;
                    $orderRooms['after_discount'] = ($list['price'] - $orderRooms['room_discount']) + $singleDayExtraAmount + $eachRoomFoodPlanPrice;
