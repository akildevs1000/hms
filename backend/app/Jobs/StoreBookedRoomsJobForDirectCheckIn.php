...
class StoreBookedRoomsJobForDirectCheckIn implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            foreach ($rooms as $room) {
                ...
                $room['booking_status'] = BookedRoom::CHECKED_IN;
                $room['room_status'] = BookedRoom::CHECKED_IN;

                $room['check_in'] = date('Y-m-d');
                $room['actual_check_in_time'] = date('H:i');
                $room['actual_check_out_time'] = "---";
