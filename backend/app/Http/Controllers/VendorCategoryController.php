...
class VendorCategoryController extends Controller
{
    ...
    {
        return VendorCategory::where("company_id", request("company_id",1))->get();
    }
    ...
    {
        return VendorCategory::where("company_id", request("company_id",1))->paginate(request("per_page", 50));
    }
