...
export default {
  ...
  methods: {
    ...
    getDataFromApi(url = this.endpoint, customPage = 0) {
      if (this.from_date && this.to_date) {
        ...
        this.$axios.get(url, options).then(({ data }) => {
          let pendingData = data.data.filter((e) => e.balance > 0);
          this.data = pendingData;
          this.calculateStates(pendingData);
          this.pagination.current = data.current_page;
          this.pagination.total = data.last_page;
          this.loading = false;
          this.totalRowsCount = pendingData.length || 0;
          this.currentPage = page;
    ...
    calculateStates(data) {
      let countResult = data.reduce((acc, { type, balance }) => {
        // Check if the current type already exists in the accumulator
      ...
      this.stats = [
        {
          icon: "mdi-walk",
          value: this.$utils.currency_format(countResult.Walking || 0),
          label: "WALKING",
          col: 7,
        ...
        {
          icon: "mdi-laptop",
          value: this.$utils.currency_format(countResult.Online || 0),
          label: "OTA",
          col: 7,
        ...
        },
        {
          ...
          value: this.$utils.currency_format(countResult.Corporate || 0),
          label: "Corporate",
          col: 7,
        ...
        },
        {
          ...
          value: this.$utils.currency_format(countResult.website || 0),
          label: "WebSite",
          col: 7,
        ...
        },
        {
          ...
          value: this.$utils.currency_format(countResult.Complimentary || 0),
          label: "Complimentary",
          col: 7,
        ...
        },
        {
          ...
          value: this.$utils.currency_format(countResult["Travel Agency"] || 0),
          label: "Travel Agent",
          col: 7,
