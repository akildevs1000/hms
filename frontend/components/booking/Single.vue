                  ...
                  <v-row class="my-0 py-0">
                    <v-col md="4" v-if="booking.room_category_type == 'Hall'">
                      <div class="text-box" style="float: left">
                        ...
                        <p>
                          {{
                            (booking && booking.hall_booking.event_date) ||
                            "---"
                          }}
                        </p>
                      </div>
                        ...
                        <p>
                          {{
                            (booking &&
                              ...
                              " - " +
                              getHours(booking.hall_booking.event_end_time) ||
                            "---"
                          }}
                        </p>
                      </div>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$axios
        .get(`booking_customer/${this.booking_id}`)
        .then(({ data }) => {
          //assign booking
          ...
          if (this.room_category_type == "Hall") {
            ...
            this.hallRentTotalAmount =
              data.booking.hall_booking.hall_rent_amount;
