                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col md="12" cols="12">
                                <label>Name</label>
                                <v-text-field :disabled="viewMode" v-model="editedItem.name" outlined dense small
                                    :hide-details="true" placeholder="Name"></v-text-field>
...
export default
    {
        data: () => ({
            ...
            { text: "Name", value: "name", key: "name", align: "left", sortable: true, filterable: true, filterSpecial: true },
