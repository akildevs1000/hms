              ...
              <v-card-text>
                ...
                <v-row>
                  ...
                  <v-col md="3" cols="12" sm="12" v-if="isAgent">
                    <v-select dense label="Agent Name" outlined :items="agentList" type="text" item-value="name"
                      item-text="name" v-model="room.source" :hide-details="errors && !errors.source"
                      :error="errors && errors.source" :error-messages="
                        errors && errors.source ? errors.source[0] : ''
                      "></v-select>
                  </v-col>
                  <v-col md="3" sm="12" cols="12" dense v-if="isOnline">
                    <v-select v-model="room.source" label="Source" :items="sources" dense outlined item-value="name"
                      item-text="name" :hide-details="errors && !errors.source" :error="errors && errors.source"
                      :error-messages="
                        errors && errors.source ? errors.source[0] : ''
                      "></v-select>
                  </v-col>
                  ...
                  <v-col md="3" sm="12" cols="12" dense v-if="isAgent || isOnline">
...
">+</span>
                          ...
                          <v-col md="6" cols="12">
                            <table class="food-table">
                              <tr class="food-table" style="background-color: #4390fc; color: white">
                          ...
                          <v-col md="6" cols="12">
                            <table class="food-table">
                              ...
                              <tr class="food-table" v-for="(item, index) in temp.priceList" :key="index">
                                <td class="food-table">
                                  {{ item.date }}
                                </td>
                                <td class="food-table">
