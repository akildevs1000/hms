  ...
  <div>
    ...
    >
      ...
      <v-alert
        ...
        :style="i == 1 ? 'border-top:1px solid rgba(0, 0, 0, 0.2);' : ''"
        border="left"
        colored-border
        :color="i % 2 ? 'primary' : 'deep-purple accent-4'"
        elevation="0"
        rounded="0"
        dense
        class="my-0 py-0"
      ...
      >
        <v-row dense>
          <v-col md="6" dense>
            <b class="pt-3">{{ i % 2 ? `10${i}` : `10${i}` }}</b>
            <p>{{ i % 2 ? "king" : "castle" }}</p>
          </v-col>
          <v-col md="6" dense>
            <v-btn class="mt-3" color="primary">Select</v-btn>
          </v-col>
        </v-row>
      </v-alert>
    </v-navigation-drawer>
              ...
              <v-col md="12" class="mb-10">
                ...
                >
                  <div class="d-flex justify-space-between">
                    <h6 class="px-2 mt-3">106 — King</h6>
                    <div>
                      {{ RoomDrawer }}
                      <v-btn
                        color="primary"
