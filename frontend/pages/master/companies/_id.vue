                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.name" class="error--text mt-2">{{ errors.name[0] }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.email" class="error--text mt-2">{{ errors.email[0] }}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.mol_id" class="error--text mt-2">{{ errors.mol_id[0] }}</span>
                        </div>
                      </div>

                      <div class="col-sm-4">
                        <div class="form-group">
                          <label class="col-form-label">Whatsapp Instance</label>
                          <span class="error--text">*</span>
                          <input v-model="company_payload.whatsapp_instance_id" class="form-control" type="text" />

                          <span v-if="errors && errors.whatsapp_instance_id" class="error--text mt-2">{{
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.p_o_box_no" class="error--text mt-2">{{ errors.p_o_box_no[0]
                          }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.member_from" class="error--text mt-2">{{ errors.member_from[0]
                          }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.expiry" class="error--text mt-2">{{ errors.expiry[0] }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.max_branches" class="error--text mt-2">{{ errors.max_branches[0]
                          }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.max_employee" class="error--text mt-2">{{ errors.max_employee[0]
                          }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.max_devices" class="error--text mt-2">{{ errors.max_devices[0]
                          }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.logo" class="error--text mt-2">{{ errors.logo[0] }}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.number" class="error--text mt-2">{{ errors.number[0] }}</span>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.position" class="error--text mt-2">{{ errors.position[0] }}</span>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.whatsapp" class="error--text mt-2">{{ errors.whatsapp[0] }}</span>
                        </div>
                      </div>
                    </div>
                    <v-row>
                ...
                <v-card flat>
                  <v-card-text>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label class="col-form-label">Lat <span class="error--text">*</span></label>
                          <input v-model="geographic_payload.lat" type="number" class="form-control" />
                          <span v-if="errors && errors.lat" class="error--text mt-2">{{ errors.lat[0] }}</span>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="form-group">
                          <label class="col-form-label">Lon <span class="error--text">*</span></label>
                          <input v-model="geographic_payload.lon" type="number" class="form-control" />
                          <span v-if="errors && errors.lon" class="error--text mt-2">{{ errors.lon[0] }}</span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <span v-if="errors && errors.location" class="error--text mt-2">{{ errors.location[0] }}</span>
                        </div>
                      </div>
                    </div>
                    <v-row>
                        ...
                        <div class="row">
                          <v-col md="6" sm="12" cols="12" dense>
                            <label class="col-form-label">Password
                              <span class="error--text">*</span></label>
                            <v-text-field dense outlined :hide-details="errors && !errors.password" :append-icon="
                            ...
                            " :type="show_password ? 'text' : 'password'" v-model="user_payload.password"
                              ...
                              :error="errors && errors.password" :error-messages="
...
" :error="errors && errors.show_password_confirm" :error-messages="
...
export default {
  ...
  methods: {
    ...
    update_company() {
      ...
      payload.append("whatsapp_instance_id", this.company_payload.whatsapp_instance_id);
