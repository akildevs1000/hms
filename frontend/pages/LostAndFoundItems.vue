                                    ...
                                    <v-card-text>
                                        <v-row class="mb-2 mt=4" v-if="editedIndex == -1">
                                            <v-col md="3" cols="12">
                                                ...
                                                <v-text-field type="number" v-model="bookingId"
                    ...
                    <v-tooltip top color="primary">
                        <template v-slot:activator="{ on, attrs }">
                            <v-btn dense class="ma-0 px-0" x-small :ripple="false" text v-bind="attrs" v-on="on">
                                <v-icon color="white" class="ml-2" @click="getDataFromApi()" dark>mdi
                                    mdi-reload</v-icon>
                            </v-btn>
                        </template>
                        <span>Reload</span>
                                ...
                                <tr v-if="isFilter">
                                    <td v-for="header in headers" :key="header.text">
                                        ...
                                        <v-menu v-if="header.filterSpecial && header.value == 'found_datetime'"
                                            ...
                                            <v-date-picker style="height: 350px" v-model="filters[header.value]" no-title
                                        ...
                                        <v-menu v-if="header.filterSpecial && header.value == 'created'"
                                            ...
                                            <v-date-picker style="height: 380px" v-model="filters[header.value]" no-title
                                                scrollable @input="applyFilters()">
                                                <v-spacer></v-spacer>
                            ...
                            <template v-slot:item.options="{ item }">
                                <v-menu bottom left>
                                    ...
                                    <v-list width="120" dense>
                                        <v-list-item @click="gotoViewItemDetails(item.id)">
...
export default {
    ...
    methods: {
        ...
        getStatus(status) {
            ...
            else if (status == 2) return 'Recovered';
        },
        searchBookingId(url = this.endpoint) {
            ...
            this.$axios.post(`${url}/search_by_reference/${this.bookingId}`, options).then(({ data }) => {
