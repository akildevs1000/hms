<template>
    <div>
        <v-row>
            ...
            <v-col md="12" v-if="!enable_payment">
                <v-tabs v-model="activeTab" :vertical="vertical" background-color="primary" dark show-arrows>
                    <div class="py-3" style="background-color: #1259a7">
                        <span class="mx-2">Step 1: New Reservation</span>
                    </div>
                    <v-spacer></v-spacer>
                    <v-tab active-class="active-link">
                        <v-icon> mdi mdi-account-tie </v-icon>
                    </v-tab>
                    <v-tab disabled active-class="active-link">
                    ...
                    <v-tab-item>
                        ...
                        " :src="showImage"></v-img>
                                                    ...
                                                    <!-- <div class="mt-2 ml-4" v-if="customer.document">
                                                        <v-btn small dark class="primary pt-4 pb-4"
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col md="12" dense>
                                                            <v-autocomplete label="Type" v-model="customer.customer_type"
                                                                :items="['Company', 'Regular', 'Corporate']" dense
                                                                item-text="name" item-value="id" outlined
                                                                :hide-details="true"></v-autocomplete>
                                                        </v-col>
                                                        <v-col md="12" cols="12" sm="12">

                                                            <v-autocomplete :rules="[rules.required]" required
                                                                v-model="customer.title" :items="titleItems" label="Title *"
                                                                dense item-text="name" item-value="name"
                                                                :hide-details="errors && !errors.title"
                                                                :error="errors && errors.title" :error-messages="errors && errors.title ? errors.title[0] : ''
                                                                    " outlined></v-autocomplete>
                                                        </v-col>
                                                        <v-col md="12" cols="12" sm="12">
                                                            <v-text-field :rules="[rules.required]" label="First Name *"
                                                                dense outlined type="text" v-model="customer.first_name"
                                                        ...
                                                        <v-col md="12" cols="12" sm="12">
                                                            <v-text-field label="Last Name" dense :hide-details="true"
                                                                outlined type="text"
                                                                v-model="customer.last_name"></v-text-field>
                                                        </v-col>
                                                        <v-col md="12" cols="12" sm="12">
                                                            <v-text-field :rules="[rules.required]" dense
                                                                label="Contact No *" outlined type="number"
                                                        ...
                                                        <v-col md="12" cols="12" sm="12">
                                                            <v-text-field :rules="[rules.required]" dense
                                                                label="Whatsapp No" outlined type="number"
                                                        ...
                                                        <v-col md="12" cols="12" sm="12">
                                                            <v-text-field :rules="[rules.required]" dense label="Email *"
                                                                outlined type="email" v-model="customer.email"
                                                                :hide-details="errors && !errors.email"
                                                                :error="errors && errors.email" :error-messages="errors && errors.email ? errors.email[0] : ''
                                                                    "></v-text-field>
                                                        </v-col>
                                                        <v-col md="12" cols="12" sm="12">
                                                            <v-textarea :rules="[rules.required]" rows="3" label="Address"
                                                                v-model="customer.address" outlined
                                                ...
                                                <v-col md="4" cols="12">
                                                    <v-col md="12" cols="12" sm="12">
                                                        <v-autocomplete :rules="[rules.required]" v-model="customer.nationality"
                                                            :items="countryList" label="Nationality" item-text="name"
                                                    ...
                                                    <v-col md="12" cols="12" sm="12">
                                                        <v-menu :rules="[rules.required]" v-model="customer.dob_menu"
                                                            :close-on-content-click="false" :nudge-right="40"
                                                            transition="scale-transition" offset-y min-width="auto">
                                                            <template v-slot:activator="{ on, attrs }">
                                                                <v-text-field :rules="[rules.required]"
                                                                    v-model="customer.dob" readonly label="DOB" v-on="on"
                                                                    v-bind="attrs" :hide-details="true" dense
                                                                    outlined></v-text-field>
                                                            </template>
                                                            <v-date-picker v-model="customer.dob" title
                                                                @input="customer.dob_menu = false"></v-date-picker>
                                                        </v-menu>
                                                    </v-col>
                                                    <v-col md="12">
                                                        <v-autocomplete :rules="[rules.required]" label="Purpose"
                                                            v-model="room.purpose" :items="purposes" dense
                                                            :hide-details="true" outlined></v-autocomplete>
                                                    </v-col>

                                                    <v-col md="12" sm="12" cols="12" dense>
                                                        <v-autocomplete :rules="[rules.required]"
                                                            v-model="customer.id_card_type_id" :items="idCards" dense
                                                            label="ID Card Type" outlined item-text="name" item-value="id"
                                                    ...
                                                    <v-col md="12" cols="12" sm="12">
                                                        <v-text-field :rules="[rules.required]" dense label="ID Card"
                                                            outlined type="text" v-model="customer.id_card_no"
                                                            :hide-details="errors && !errors.id_card_no"
                                                            :error="errors && errors.id_card_no" :error-messages="errors && errors.id_card_no ? errors.id_card_no[0] : ''
                                                                "></v-text-field>
                                                    </v-col>
                                                    <v-col md="12" cols="12" sm="12">
                                                        <v-text-field dense outlined label="GST" type="text"
                                                            v-model="customer.gst_number"
                                                            :hide-details="errors && !errors.gst_number"
                                                            :error="errors && errors.gst_number" :error-messages="errors && errors.gst_number ? errors.gst_number[0] : ''
                                                                "></v-text-field>
                                                    </v-col>
                                        ...
                                        <v-text-field dense label="Car Number" outlined :hide-details="true" type="text"
                                            v-model="customer.car_no"></v-text-field>
                                                    ...
                                                    <v-col md="12">
                                                        <v-textarea rows="3" label="Customer Request(If any)"
                                                            v-model="room.request" :hide-details="true"
                                                            outlined></v-textarea>
                                                    </v-col>
                                                </v-col>
                                            </v-row>
                                            ...
                                            <v-row>
                                                <v-col md="6">
                                                    <v-btn @click="backtoPage()" dark color="primary">
                                                        Back To Customer Details
                                                    </v-btn>
                                                </v-col>
                                                <v-col cols="6" class="text-right">
                                                    <v-btn dense @click="nextTab" color="primary">Next</v-btn>
                                                </v-col>
                                            </v-row>
                                        </v-card-text>
                                    </v-card>
                    ...
                    <v-tab-item>
                        ...
                        color="deep-purple accent-4" -->
                                        <v-alert colored-border elevation="2">
                                            ...
                                            <div class="mt-3">
                                                <v-row>
                                                    <v-col md="2" sm="4" cols="12" dense>
                                                        <label class="col-form-label">Adult <span
        ...
        ">+</span>
                                                    ...
                                                    <v-col md="4" sm="12" cols="12" dense
                                                        class="mb-0 pb-0 d-flex justify-center mt-6">
                                                        <v-radio-group row dense class="py-0 my-0">
                                                            <v-checkbox v-model="temp.breakfast" label="Breakfast"
                                                                value="breakfast" class="px-3 py-0 my-0"
                                                                @change="meal_cal(temp.breakfast)" :hide-details="true">
                                                            </v-checkbox>
                                                            <v-checkbox v-model="temp.lunch" label="Lunch" value="lunch"
                                                                class="px-3 py-0 my-0" @change="meal_cal(temp.lunch)"
                                                                :hide-details="true">
                                                            </v-checkbox>
                                                            <v-checkbox v-model="temp.dinner" label="Dinner" value="dinner"
                                                                class="px-3 py-0 my-0" @change="meal_cal(temp.dinner)"
                                                                :hide-details="true">
                                                            </v-checkbox>
                                                        </v-radio-group>
                                                    </v-col>
                                                    ...
                                                    <!-- </v-row> -->
                                                    <v-col md="12" cols="12" class="d-flex py-0 my-0 justify-center">
      ...
      color: #FFF;float:right">
                                                    ...
                                                    <!-- <v-col md="3" sm="12" cols="12" dense>
                                                        ...
                                                        <v-autocomplete v-model="extraPayType"
                                                            :items="['Discount', 'ExtraAmount']" dense :hide-details="true"
                                                            outlined></v-autocomplete>
                                                    </v-col>
                                                    <v-col md="4" sm="12" cols="12" dense v-if="extraPayType == 'Discount'">
                                                        ...
                                                        <v-text-field dense outlined type="number"
                                                            v-model="temp.room_discount" :hide-details="true"
                                                            @keyup="updateDiscount(temp)"></v-text-field>
                                                    </v-col>
                                                    <v-col md="4" sm="12" cols="12" dense v-if="extraPayType == 'Discount'">
                                                        <label class="col-form-label"> Reason </label>
                                                        <v-text-field dense outlined type="text"
                                                ...
                                                <v-row class="mt-3">
                                                    <v-col md="6">
                                                        <v-btn @click="prevTab" dark color="primary">
                                                            Back To Customer Details
                                                        </v-btn>
                                                    </v-col>
                                                    <v-col md="6" style="font-weight:bold">
                                                        <v-btn @click="add_room" style="color:#FFF" class="float-right"
                                                            color="green">
                                                            Step1 : Confirm Room
                                                        </v-btn>
                                                    </v-col>
            ...
            <v-col md="12" v-if="enable_payment">
                <v-toolbar class="rounded-md" color="primary" dense flat dark>
                    <h2 class="text-center mb-2 mt-2">Step 2 : Online Payment confirmation</h2>
                    <v-spacer></v-spacer>
                ...
                <v-row>
                    ...
                    <v-col md="6">
                        ...
                        <div v-for="(item, index) in selectedRooms" :key="index">
                            <v-card>
                                <div class="px-5 pt-2 d-flex justify-space-between bold"
                                    style="font-size: 16px;font-weight:bold  ">
                                    <span>Allocated Room Number- {{ item.room_no }}</span>
                                    <span>Room Category: {{ item.room_type }}</span>
                                </div>
                                <v-divider></v-divider>
                                <section class="payment-section">
                                    <div class="input-group input-group-sm px-5 pt-2 text-center">
                                        ...
                                        <v-card class="pa-2" style="width: 25%" outlined tile>
                                            {{ getMealSeparate(item.meal)[0] ? 'Breakfast' : '' }}
                                        </v-card>
                                        <v-card class="pa-2" style="width: 25%" outlined tile>
                                            {{ getMealSeparate(item.meal)[1] ? 'Lunch' : '' }}
                                        </v-card>
                                        <v-card class="pa-2" style="width: 25%" outlined tile>
                                            {{ getMealSeparate(item.meal)[2] ? 'Dinner' : '' }}
                                        </v-card>
                                    </div>
                            ...
                            <v-card>
                                ...
                                <section>
                                    <div class="input-group input-group-sm px-5 py-0">
                                        ...
                                        <div type="text" class="form-control text-right" aria-label="Sizing example input"
                                            aria-describedby="inputGroup-sizing-sm" disabled>
                                            {{ customer.first_name || "---" }}
                                        </div>
                                    </div>
                  ...
                  Payment
                                ...
                                <section class="payment-section pt-0 mt-1">
                                    ...
                                    <div class="input-group input-group-sm px-3 mb-5" v-if="enable_payment">
                ...
                <v-row>
                    <v-col cols="12" class="text-right">
                        <v-btn color="green" height="40" @click="store" :loading="subLoad" dark>Step2:
                            Online Payment
                        </v-btn>
                    </v-col>
                </v-row>
                ...
                <v-card-text>
                    <v-row>
                        <v-col md="12" cols="12" sm="12">
                            ...
                            <v-text-field dense outlined type="text" placeholder="Enter your Mobile Number"
                                v-model="search.mobile" :hide-details="true"></v-text-field>
                        </v-col>
                    </v-row>
                </v-card-text>
                <v-divider></v-divider>
                        ...
                        <div class="input-group input-group-sm px-3">
                            <span class="input-group-text" id="inputGroup-sizing-sm"
                                ...
                                <v-autocomplete v-model="room.payment_mode_id" :items="[
                                    ...
                                    { id: 5, name: 'UPI' },
                                    { id: 6, name: 'Cheque' },
                                ]" cache-items item-text="name" item-value="id" class="ma-0 pa-0" dense flat
                                    hide-no-data hide-details solo elevation="0" background-color="#E9ECEF"
        ...
        <v-navigation-drawer v-model="RoomDrawer" temporary right :fixed="true" :clipped="true" style="z-index: 1000">
            <v-list-item>
                <v-list-item-content>
                    ...
                    <v-list-item-title>
                        <v-text-field label="Search..." outlined dense class="mt-3" v-model="search_available_room"
                            @keyup="searchAvailableRoom(search_available_room)"></v-text-field>
                    </v-list-item-title>
                </v-list-item-content>
            </v-list-item>
            <!-- :color="item.background" -->
            <v-alert style="border-bottom: 1px solid rgba(0, 0, 0, 0.2)"
                :style="index == 1 ? 'border-top:1px solid rgba(0, 0, 0, 0.2);' : ''" border="left" colored-border
                :color="item.background" elevation="0" rounded="0" dense class="my-0 py-0"
                v-for="(item, index) in availableRooms" :key="index">
                <v-row dense>
                    <v-col md="6" dense>
                    ...
                    <v-col md="6" dense>
                        <v-btn class="mt-3" @click="selectRoom(item)" small color="primary">Select</v-btn>
                    </v-col>
                </v-row>
            </v-alert>
        </v-navigation-drawer>
...
export default {
    ...
    created() {
        this.company_id = this.$store.state.widget_data.company_id;

        this.room.source = "widget";

        this.customer.company_id = this.company_id;
        this.temp.company_id = this.company_id;
        this.room.company_id = this.company_id;
        this.get_food_price();
    ...
    methods: {
        ...
        backtoPage() {
            this.$router.push('/widget/' + this.company_id);
        },
        prevTab() {
            if (this.activeTab > 0) {
                this.activeTab -= 1;
        ...
        get_reservation() {
            this.reservation = this.$store.state.widget_data;
        ...
        add_room() {
            ...
            this.clear_add_room();
            this.alert("Success!", "Room details are selected. Please check and confirm the payment details", "success");
            this.isSelectRoom = false;

            this.enable_payment = true;
            return;
        },
            ...
            this.$axios
                ...
                .then(({ data }) => {
                    ...
                    if (!data.status) {
                        ...
                        this.$store.commit("widget_data_booking_confirmation", payload);

                        if (confirm('Are you sure want to complete the Payment')) {
                            this.store_booking();
                        }
                        else {
                            alert("Your Transaction is canlled.");
                            this.$router.push(`/widget/${this.company_id}`);
                        }
