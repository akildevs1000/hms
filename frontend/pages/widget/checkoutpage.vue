                ...
                <v-tabs v-model="activeTab" :vertical="vertical" background-color="primary" dark show-arrows>
                    ...
                    <v-tab-item>
                        ...
                        " :src="showImage"></v-img>
                                                ...
                                                <v-col md="4" cols="12">
                                                    <v-row>
                                                        ...
                                                        <v-col md="12" cols="12" sm="12">
                                                            ...
                                                            <v-select :rules="[rules.required]" required
                                                ...
                                                <v-col md="4" cols="12">
                                                    <v-col md="12" cols="12" sm="12">
                                                        <v-select :rules="[rules.required]" v-model="customer.nationality"
                                                    ...
                                                    <v-col md="12">
                                                        <v-select :rules="[rules.required]" label="Purpose"
