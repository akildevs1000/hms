                    ...
                    <v-card-text>
                      ...
                      <v-row>
                        ...
                        <v-col cols="6" class="text-right">
                          <v-btn dense @click="nextTab" color="primary"
                            >Next</v-btn
                          >
                        </v-col>
                      </v-row>
      ...
      <v-col md="12" v-if="enable_payment">
        <v-toolbar class="rounded-md" color="primary" dense flat dark>
          <h2 class="text-center mb-2 mt-2">
            Step 2 : Online Payment confirmation
          </h2>
          <v-spacer></v-spacer>
        </v-toolbar>
        ...
        <v-row>
          ...
          <v-col md="6">
            <div v-for="(item, index) in selectedRooms" :key="index">
              <v-card>
                <div
                  class="px-5 pt-2 d-flex justify-space-between bold"
            ...
            <div>
              <v-card>
                ...
                <section class="payment-section pt-0 mt-1">
                  ...
                  <div
                    class="input-group input-group-sm px-3 mb-5"
                    v-if="enable_payment"
                  >
...
export default {
  ...
  created() {
    ...
    if (!this.temp.room_no) this.$router.push("/widget");
  },
  computed: {
    showImage() {
  ...
  methods: {
    ...
    nextTab() {
      if (!this.$refs.myform.validate()) {
        this.alert("oops", "Some fileds are missing", "error");
      } else {
        this.activeTab += 1;
      }
    ...
    add_room() {
      ...
      this.alert(
        "Success!",
        "Room details are selected. Please check and confirm the payment details",
        "success"
      );
      ...
      this.$axios
        ...
        .then(({ data }) => {
          ...
          if (!data.status) {
            ...
            this.alert(
              "Success!",
              "Successfully room booking complated",
              "success"
            );
            // this.$router.push('/');
